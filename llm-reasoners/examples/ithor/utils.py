...
def load_models(crl_model_path, autoencoder_path, causal_mapper_path, tokenizer_path, single_causal_mapper=False, nl_model_path=None, device='cuda', tokenizer_type='open_clip'):
