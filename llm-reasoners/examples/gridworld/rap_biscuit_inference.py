...
from world_model import CausalWorldModel, LMWorldModel, GWState, GWAction
...
def rap_biscuit(base_model: LanguageModel,
              ...
              device='cuda',
              config_file: str = "examples/gridworld/val_metadata.json",
              data_path : str = "examples/gridworld/data/step_2.pth",
              n_iters: int = 30,
              use_causal_wm: bool = True,
              **search_algo_params):

    run = wandb.init(project='gridworld_mcts', name=f'{search_algo.__name__}_depth_{depth_limit}_data_{data_path.split("/")[-1]}-w_exp_{search_algo_params["w_exp"]}')
...
if __name__ == '__main__':
    ...
    def main(base_lm: Literal['llama', 'llama.cpp', 'llama-2', 'hf', 'exllama', 'exllamav2'] = 'llama-2',
             ...
             batch_size: int = 1,
             prompt: str = 'examples/gridworld/prompts/prompt_2step.json',
             disable_log: bool = False,
             disable_tqdm: bool = False,
             **kwargs):
